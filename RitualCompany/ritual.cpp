...
void ProductInputScreen::setProduct() // добавить данные о товаре
{
    ...
    cin >> art;
    cin.ignore(80, '\n');
    cout << "Enter the price (499.9): " << endl;
    cin >> prc;
    cin.ignore(80, '\n');
...
{
    float totalExpenses = 0.0; // Сумма по всем категориям расходов
    ...
    while (true)
    {
        ...
        if (ty == 'i') // ввод данных
        {
            ...
            case 'p': ptrProductInputScreen =
                ...
                cout << "Product was successfully added\n" << endl;
                break;
            ...
            case 'e': ptrExpenseInputScreen =
                ...
                cout << "Expense was successfully added\n" << endl;
                break;
